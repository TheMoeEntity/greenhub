...
const Header = () => {
    return (
        <div className='lg:absolutse top-0 left-0 w-full'>
            <div className="w-full py-3 gap-y-5 text-sm bg-[#  background-color: #151C1F;] flex flex-col md:flex-row font-light text-[#CECECE] justify-center items-center md:justify-around">
